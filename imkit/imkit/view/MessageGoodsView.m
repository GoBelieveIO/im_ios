...
@interface MessageGoodsView()
@property(nonatomic) UILabel *titleLabel;
@property(nonatomic) UILabel *contentLabel;
@end
@implementation MessageGoodsView
...
- (void)setMsg:(IMessage*)msg {
    ...
    MessageGoodsContent *content = msg.goodsContent;
...
- (CGRect)bubbleFrame {
    ...
    return CGRectMake(floorf((self.frame.size.width - bubbleSize.width)/2.0),
                      floorf(kMarginTop),
...
-(void)layoutSubviews {
    ...
    CGFloat imgX = (bubbleFrame.origin.x + kBubblePaddingHead + 8);
